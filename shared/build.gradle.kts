...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = Configs.Ios.FRAMEWORK_NAME
            isStatic = true
            xcf.add(this)

            // Add bundle ID to fix the warning
            freeCompilerArgs += listOf(
                "-Xbinary=bundleId=${Configs.Shared.NAMESPACE}"
            )
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(compose.components.resources) // Keep this in shared
...
android {
    namespace = Configs.Shared.NAMESPACE
...
compose.resources {
    publicResClass = true
    packageOfResClass = "${Configs.Shared.NAMESPACE}.resources"
